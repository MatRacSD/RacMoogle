...
namespace MoogleEngine
{
    ...
    public class Document : IComparable<Document>
    {
        ...
        /// </summary>
        /// <value></value>
        public string[] contentUnnormalized { get; set; }
        /// <summary>
        ...
        /// </summary>
        /// <value></value>
        public double[] TFRoot { get; protected set; }
        /// <summary>
        ...
        {
            TFIDF = new double[words.wordCount.Count];
            int counter = 0;
            foreach (var item in words.wordCount)
            {
        ...
        {
            TFRoot = new double[words.rootWords.Count()];
            int counter = 0;
        ...
        private string GetFragment(string word)
        {
            ...
            int index = Array.IndexOf(contentUnnormalized, word);
            int startIndex = Math.Max(0, index - 5);
            int endIndex = Math.Min(contentUnnormalized.Length - 1, index + 5);
            ...
            string fragment = string.Join(" ", contentUnnormalized[startIndex..(endIndex + 1)]);
